...
int stareczastki=0;
  ...
  while (cr.GetRun (Run)) {
	...
	//TH1D yHistogram ("energy", "y coor distribution", 50, -3, 1);
	...
	//TH1D hEnergy ("energy", "energy spectra of EM", 50, -3, 1);
	  ...
	  TH2D* histogramXY = new TH2D("center", "" ,100, -10000,10000,100,-10000,10000);		
      ...
      while (cr.GetData (Data)) {
		...
		PlotParticles2D ( *histogramWE, w,e,0);
 ...
 cout << "Nowe Cząstki:" << noweczastki << endl;
 cout << "Stare Cząstki:" << stareczastki << endl;
  return 0;
}
